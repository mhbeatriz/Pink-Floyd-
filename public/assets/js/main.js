...
function darkSide() {
  ...
  <div class="message">
     <p>
     Grabado en el <span class="span">Abbey Road(The Beatles)</span>, en el 1972, fue el tercer álbum más vendido en la historia de la música en el que se buscaba narrar a través de sus canciones las presiones a las que debía enfrentarse un músico. Y en el que encontramos temas como <span class="span">Money</span>, en el que se esconde una crítica sarcástica del dinero, denunciando la opresión y corrupción que hay detrás y como puede cambiar a las personas en seres mas ambiciosos y egoístas. Otros como <span class="span">Time</span> La letra trata sobre el paso del tiempo: el tiempo puede pasar, pero muchas personas no se dan cuenta hasta que es demasiado tarde.Es el único tema del disco en el que participan como compositores los cuatro miembros de la banda, y en el que finaliza con el tema <span class="span">Breathe</span> es una invitación a tomarse un respiro, a detenerse y reflexionar sobre el significado de la vida, para no caer en la búsqueda de metas sin sentido.
     </p>
     </div>
